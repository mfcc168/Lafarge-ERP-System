...
from .views import invoice_list, invoice_detail, download_invoice_pdf, download_order_form_pdf\
...
urlpatterns = [
    ...
    path('orderform/<str:invoice_number>/download/', download_order_form_pdf, name='download_order_form_pdf'),  # Add prefix 'invoice/'
    path('', home, name='home'),
]
